...
def export_ode_model():
    ...
    Cd = 1.0e+1  # [Nm/kHz^2]
    Ct = 5.95e+2  # [N/kHz^2]
    l = 0.23  # [m] distance between the motor's center and the axis of rotation
    Im = 0.08  # [g.m^2] rotor inertia
    d = 0.5  # [kN.m.s] rotor drag coefficient
    ...
    dw1 = (t1 - Cd * w1**2 - d * w1) / Im
    dw2 = (t2 - Cd * w2**2 - d * w2) / Im
    dw3 = (t3 - Cd * w3**2 - d * w3) / Im
    dw4 = (t4 - Cd * w4**2 - d * w4) / Im
